...
<main>
    ...
    <section id="eventsStatistics">
        <?php if(!$_SESSION['fn'] && \App\Services\Auth::check()) : ?>
        <h4>
    ...
    <section id="studentsStatistics">
        ...
        <?php foreach($data['students'] as $student) : ?>
            <li class="student"><h5><?php echo $student['faculty_number']; echo $student['first_name']; echo $student['last_name'];?><h5>
                <div class="hidden">
