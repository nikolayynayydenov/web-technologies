...
(19, 81580, '13:45:00', 7, 100, 'проверено от инструктор\r\n', 'save-users-list-1609407912138.txt'),
(20, 81565, '13:45:00', 7, 90, 'добавен от студент-помагач\r\n', 'save-users-list-2.txt'),
(21, 81111, '13:45:00', 7, 100, NULL, 'Проверени от инструктор на място'),
(22, 81112, '13:45:00', 7, 50, NULL, 'През линк за вход'),
(23, 81113, '13:45:00', 7, 100, 'направена от инструктор\r\n', 'Ръчна проверка'),
(24, 81114, '13:45:00', 7, 100, 'списък -  всеки се записва (на хартия) - и после р', 'Ръчна проверка'),
(25, 81508, '13:45:00', 7, 100, 'проверено от инструктор\r\n', 'save-users-list-1609407912138.txt'),
(26, 81510, '13:45:00', 7, 90, 'добавен от студент-помагач', 'save-users-list-2.txt'),
(27, 81500, '10:25:00', 3, 100, 'проверено от инструктор\r\n', 'save-users-list-1609407912138.txt'),
(28, 81501, '10:25:00', 3, 90, 'добавен от студент-помагач\r\n', 'save-users-list-2.txt'),
(29, 81502, '10:25:00', 3, 100, NULL, 'Проверени от инструктор на място'),
(30, 81503, '10:25:00', 3, 50, NULL, 'През линк за вход'),
(31, 81504, '10:25:00', 3, 100, 'направена от инструктор\r\n', 'Ръчна проверка'),
(32, 81506, '10:25:00', 3, 100, 'списък -  всеки се записва (на хартия) - и после р', 'Ръчна проверка'),
(33, 81111, '10:25:00', 3, 100, 'проверено от инструктор\r\n', 'save-users-list-1609407912138.txt'),
(34, 81565, '10:25:00', 3, 90, 'добавен от студент-помагач', 'save-users-list-2.txt');
