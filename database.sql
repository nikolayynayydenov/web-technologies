...
(2, 1234, '11:15:00', 1, 100, 'проверено от инструктор\r\n', 'save-users-list-1609407912138.txt'),
(3, 929, '10:15:00', 1, 90, 'добавен от студент-помагач\r\n', 'save-users-list-2.txt'),
(4, 421, '10:15:00', 1, 100, NULL, 'Проверени от инструктор на място'),
(5, 2340, '10:15:00', 1, 50, NULL, 'През линк за вход'),
(6, 4524, '10:15:00', 1, 100, 'направена от инструктор\r\n', 'Ръчна проверка'),
(7, 24233, '10:15:00', 1, 100, 'списък -  всеки се записва (на хартия) - и после р', 'Ръчна проверка'),
...
(11, 1234, '11:15:00', 6, 100, 'проверено от инструктор\r\n', 'save-users-list-1609407912138.txt'),
(12, 929, '10:15:00', 6, 90, 'добавен от студент-помагач\r\n', 'save-users-list-2.txt'),
(13, 421, '10:15:00', 6, 100, NULL, 'Проверени от инструктор на място'),
(14, 2340, '10:15:00', 6, 50, NULL, 'През линк за вход'),
(15, 4524, '10:15:00', 6, 100, 'направена от инструктор\r\n', 'Ръчна проверка'),
(16, 24233, '10:15:00', 6, 100, 'списък -  всеки се записва (на хартия) - и после р', 'Ръчна проверка'),
...
(19, 81580, '00:00:00', 7, 100, 'проверено от инструктор\r\n', 'save-users-list-1609407912138.txt'),
(20, 81565, '00:00:00', 7, 90, 'добавен от студент-помагач\r\n', 'save-users-list-2.txt'),
(21, 81111, '00:00:00', 7, 100, NULL, 'Проверени от инструктор на място'),
(22, 81112, '00:00:00', 7, 50, NULL, 'През линк за вход'),
(23, 81113, '00:00:00', 7, 100, 'направена от инструктор\r\n', 'Ръчна проверка'),
(24, 81114, '00:00:00', 7, 100, 'списък -  всеки се записва (на хартия) - и после р', 'Ръчна проверка'),
(25, 81508, '00:00:00', 7, 100, 'проверено от инструктор\r\n', 'save-users-list-1609407912138.txt'),
(26, 81510, '00:00:00', 7, 90, 'добавен от студент-помагач', 'save-users-list-2.txt'),
(27, 81500, '00:00:00', 3, 100, 'проверено от инструктор\r\n', 'save-users-list-1609407912138.txt'),
(28, 81501, '00:00:00', 3, 90, 'добавен от студент-помагач\r\n', 'save-users-list-2.txt'),
(29, 81502, '00:00:00', 3, 100, NULL, 'Проверени от инструктор на място'),
(30, 81503, '00:00:00', 3, 50, NULL, 'През линк за вход'),
(31, 81504, '00:00:00', 3, 100, 'направена от инструктор\r\n', 'Ръчна проверка'),
(32, 81506, '00:00:00', 3, 100, 'списък -  всеки се записва (на хартия) - и после р', 'Ръчна проверка'),
(33, 81111, '00:00:00', 3, 100, 'проверено от инструктор\r\n', 'save-users-list-1609407912138.txt'),
(34, 81565, '00:00:00', 3, 90, 'добавен от студент-помагач', 'save-users-list-2.txt');
...
(1, 'JavaScript', 'Основи за javascript', '2021-01-20', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1),
(2, 'Представяне на знания', 'Кратко описание на събитието', '2021-02-11', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 12),
(3, 'Първо събитие', 'Започваме поредица', '2021-02-14', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 13),
(4, 'Събитие на Стефан', 'описание', '2021-02-11', '00:00:00', '00:00:00', 14),
(5, 'Второ събитие', 'това е второто събитие на Петър', '2021-02-12', '00:00:00', '00:00:00', 13),
(6, 'Трето събитие на Петър', 'Ранно събитие', '2021-02-13', '00:00:00', '00:00:00', 13),
(7, 'Четвърто събитие', 'Това е четвъртото събитие!', '2021-02-16', '00:00:00', '00:00:00', 13);
